...
function Header()
{
    ...
    $this->Cell(190,-17,utf8_decode('INGRESO A BODEGA'),0,1,'C');
...
$pdf->Cell(15,10,utf8_decode('Bodega:  '));
$pdf->SetFont('Arial','',8);
$pdf->Cell(0,10,utf8_decode('DIR. PROV. AGROP. DE ORELLANA'));
$pdf->SetFont('Arial','B',8);
$pdf->Cell(-35);
...
$pdf->Ln(5);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(0,10,utf8_decode('Nombre del Proveedor:'));
$pdf->Cell(-158);
$pdf->SetFont('Arial','',8);
$pdf->Cell(0,10,utf8_decode($_POST['origen']));
$pdf->SetFont('Arial','B',8);
$pdf->Cell(-35);
...
$pdf->Ln(5);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(0,10,utf8_decode('No. Fact. Proveedor: '));
$pdf->Cell(-160);
$pdf->SetFont('Arial','',8);
$pdf->Cell(0,10,utf8_decode($_POST['numfac']));
$pdf->Ln(15);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(0,10,utf8_decode('Concepto:  '));
$pdf->SetFont('Arial','',8);
$pdf->Cell(-172);
$pdf->Cell(0,10,utf8_decode($_POST['concepto']));
$pdf->Cell(-100);
$pdf->SetFont('Arial','B',8);
$pdf->Ln(10);
$pdf->Cell(190,5,'',1,1,'');
...
$pdf->Cell(1);
$pdf->SetFont('Arial','',8);
$pdf->Cell(50,26,utf8_decode('Visto Bueno'),0,0,'C');
$pdf->Cell(70,26,utf8_decode('Recibí'),0,0,'C');
$pdf->Cell(70,26,utf8_decode('Revisado'),0,0,'C');
...
$pdf->Ln(5);
$pdf->SetFont('Arial','',8);
$pdf->Cell(50,26,utf8_decode('Director'),0,0,'C');
$pdf->Cell(70,26,utf8_decode('Guarda Almacén'),0,0,'C');
$pdf->Cell(70,26,utf8_decode('Contador'),0,0,'C');
...
Agregarventa($dia,$sum,'Ingreso','glyphicon glyphicon-arrow-down',$cant,$_SESSION['username'],$neimarchivo);
Agregararticulos();
?>
